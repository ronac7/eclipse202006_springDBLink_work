	...
	$(document).ready(function() {
		...
		$("#insertData").click(function(){
			...
			if(confirm('등록을 진행할까요?')) {
				$("#deptForm").attr("action", "/department/insertDepartment.jj");
				$("#deptForm").submit();
			}
		});
		...
		$("#updateData").click(function(){
			...
			if(confirm('수정을 진행할까요?')) {
				$("#deptForm").attr("action", "/department/updateDepartment.jj");
				$("#deptForm").submit();
			}
		});
		...
		$("#deleteData").click(function(){
			if(confirm('삭제를 진행할까요?')) {
				$("#deptForm").attr("action", "/department/deleteDepartment.jj");
				$("#deptForm").submit();
			}
		});
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" id="deptname"
							name="deptname" value="${DeptVO.deptname}" /></td>
					</tr>
					<tr>
