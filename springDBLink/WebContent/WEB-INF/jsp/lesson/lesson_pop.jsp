	...
	$(document).ready(function(){
		...
		$("#insertData").click(function(){
			...
			if(confirm('등록을 진행할까요?')) {
				$("#lessonForm").attr("action", "/lesson/insertLesson.jj");
				$("#lessonForm").submit();
			}
		});
		...
		$("#updateData").click(function(){
			...
			if(confirm('수정을 진행할까요?')) {
				$("#lessonForm").attr("action", "/lesson/updateLesson.jj");
				$("#lessonForm").submit();
			}
		});
		...
		$("#deleteData").click(function(){
			if(confirm('삭제를 진행할까요?')) {
				$("#lessonForm").attr("action", "/lesson/deleteLesson.jj");
				$("#lessonForm").submit();
			}
		});
